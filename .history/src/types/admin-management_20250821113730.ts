...
/**
 * @file features/admin-management/types/index.ts
 * @description TypeScript interfaces for admin management features.
 */
 ...
 */
export interface UserData extends BaseManagementItem {
  name: string
  email: string
  phone: string
 ...
 */
export interface DisputeData extends BaseManagementItem {
  disputeId: string
  product: string

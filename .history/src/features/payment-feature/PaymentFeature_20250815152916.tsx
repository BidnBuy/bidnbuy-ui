...
const PaymentFeature = ({ showAmountInput = true, name }: PaymentFeatureProps) => {
  const { selectedPayment, setSelectedPayment, topUpAmount, setTopUpAmount, walletMutation } = usePaymentFeature();

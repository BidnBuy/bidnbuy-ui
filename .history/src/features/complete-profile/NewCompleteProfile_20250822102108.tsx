...
const NewCompleteProfile = () => {
  ...
  const onSubmit = async (data: ProfileFormData) => {
    ...
    try {
      ...
      const oldpayload = {
      name: data.fullName,                // backend wants "name"
      phoneNumber: data.phoneNumber,
      profilePicture: "/images/profile-woman.png", // you might replace this with uploaded image
      address: data.address,
      proofOfAddress: data.idNumber,      // OR a file upload URL if backend expects docs
    };
      ...
      const response = await axiosInstance.patch("/api/v1/auth/update-profile", oldpayload, { withCredentials: true })

...
//   }
  ...
  <button
  type="submit"
  // disabled={!isValid || isSubmitting}  ❌ remove this for now
  className="w-full font-medium py-3 px-6 rounded-md text-white"
  style={{ backgroundColor: "#00707B" }}
>
  {isSubmitting ? "Updating..." : "Complete Profile & Create Wallet"}
</button>
</div>

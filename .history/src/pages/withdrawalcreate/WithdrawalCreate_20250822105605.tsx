...
const WithdrawCreate = () => {
  ...
  const handleWithdrawal = async (data: {
    ...
    router.push(`/withdraw/success?${searchParams.toString()}`)
  }
      ...
      <main className="px-4 py-6 md:px-8 md:py-12">
        <div className="max-w-md mx-auto md:max-w-3xl lg:max-w-4xl">
          ...
          <div className="hidden md:block mb-8">
            <Link href="/wallet-ledger" className="inline-flex items-center gap-2 text-white hover:text-teal-400 mb-4">

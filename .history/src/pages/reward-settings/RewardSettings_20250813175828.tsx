...
function RewardsToggleSection({ rewardsEnabled, handleRewardsToggle }: { rewardsEnabled: boolean, handleRewardsToggle: (enabled: boolean) => void }) {
  return (
...
function CashbackSection({ register, errors }: any) {
  return (
    <div className="mb-6">
...
function StreakCapsSection({ register, errors }: any) {
  return (
    <div className="mb-6">
...
function PlatformSellerSplitSection({ register, errors }: any) {
  return (
...
function BidCreditSettingsSection({ register, errors }: any) {
  return (
...
function ListingFeeSummarySection({ watch, storeState }: any) {
  return (
    <SettingsSection

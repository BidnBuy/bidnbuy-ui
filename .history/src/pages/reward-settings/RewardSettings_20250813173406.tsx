...
import { ToggleSwitch } from "@/components/reward-settings/toggle-switch"
import { SettingsSection } from "@/components/reward-settings/settings-section"
import { Button } from "@/components/ui/button"
import { useToast } from "@/hooks/use-toast"
import { useRewardSettingsStore } from "@/store/reward-settings-store"
import { useMutation } from "@tanstack/react-query"
import { rewardSettingsSchema, type RewardSettingsFormData } from "@/lib/validation/reward-settings-schema"
...
export default function RewardSettingsPage() {
  ...
  // Watch the rewards enabled field specifically
  const rewardsEnabled = watch("rewardsEnabled")

  // React Query mutation for saving settings
  const saveSettingsMutation = useMutation({
    mutationFn: saveRewardSettings,
    onSuccess: (data, variables) => {
      // Update Zustand store only after successful save

...
import RewardsToggleSection from "./components/RewardsToggleSection"
...
function CashbackSection({ register, errors }: CashbackSectionProps) {
  return (
    <div className="mb-6">
...
type StreakCapsSectionProps = {
  register: UseFormRegister<RewardSettingsFormData>;
  errors: FieldErrors<RewardSettingsFormData>;
}
function StreakCapsSection({ register, errors }: StreakCapsSectionProps) {
  return (
    <div className="mb-6">
...
type PlatformSellerSplitSectionProps = {
  register: UseFormRegister<RewardSettingsFormData>;
  errors: FieldErrors<RewardSettingsFormData>;
}
function PlatformSellerSplitSection({ register, errors }: PlatformSellerSplitSectionProps) {
  return (
...
type BidCreditSettingsSectionProps = {
  register: UseFormRegister<RewardSettingsFormData>;
  errors: FieldErrors<RewardSettingsFormData>;
}
function BidCreditSettingsSection({ register, errors }: BidCreditSettingsSectionProps) {
  return (
...
type ListingFeeSummarySectionProps = {
  watch: UseFormWatch<RewardSettingsFormData>;
  storeState: ReturnType<typeof useRewardSettingsStore>;
}
function ListingFeeSummarySection({ watch, storeState }: ListingFeeSummarySectionProps) {
  return (
    <SettingsSection
      ...
      <main className="px-4 py-6 md:px-8 md:py-12">
        <div className="max-w-md mx-auto md:max-w-2xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <RewardsToggleSection rewardsEnabled={rewardsEnabled} handleRewardsToggle={handleRewardsToggle} />
            <CashbackSection register={register} errors={errors} />
            <StreakCapsSection register={register} errors={errors} />
            <PlatformSellerSplitSection register={register} errors={errors} />
            <BidCreditSettingsSection register={register} errors={errors} />
            <ListingFeeSummarySection watch={watch} storeState={storeState} />

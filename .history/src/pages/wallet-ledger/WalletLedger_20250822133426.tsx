...
const WalletLedger = () => {
  ...
  const currentBidCreditBalance = useBidCreditStore(
        ...
        <div className="max-w-md mx-auto md:max-w-3xl lg:max-w-4xl">
          ...
          <div className="flex justify-center my-12">
            <Button
              ...
              className="w-full max-w-sm text-white text-lg font-semibold rounded-lg hover:opacity-90 transition-opacity py-6 flex items-center justify-center bg-[#00707B] hover:bg-teal-700"
              size="lg"
            >
              Withdraw
            </Button>

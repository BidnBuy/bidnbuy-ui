import type { ReferralStatusProps } from "../types/referrals"
    ...
    <div className="md:hidden">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-lg border border-[#00707B] bg-[#013139]">
            ...
            <div className="p-4 rounded-lg border border-[#00707B]">

...
/**
 * ReferralHero component displays the main referral message with illustration.
 * @returns {JSX.Element} The rendered referral hero section.
 */
export function ReferralHero() {
  return (
    <div className="mb-8">
      {/* Mobile Hero with Illustration */}

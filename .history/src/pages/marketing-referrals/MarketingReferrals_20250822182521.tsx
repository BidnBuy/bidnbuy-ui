...
import { ReferralsTable } from "@/components/marketing/referrals-table"
import { EmptyReferrals } from "@/components/marketing/empty-referrals"
import { useMarketingStore } from "@/store/marketing-store"
import { useReferrals } from "@/hooks/use-marketing"
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#01151C" }}>
      ...
      <main className="px-4 py-6 md:px-8 md:py-12">
        ...
        <div className="md:hidden flex items-center gap-3 mb-6">
          <Link href="/marketing" className="text-white">

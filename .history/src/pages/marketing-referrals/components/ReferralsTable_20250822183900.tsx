  ...
  if (referrals.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <Card className="p-4 bg-teal-800/30 border-teal-600/50 max-w-md mx-auto">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="border-teal-600 text-teal-300 hover:bg-teal-800"
          >
      ...
      <div className="hidden md:block">
        <Card className="overflow-hidden bg-teal-900/20 border-teal-600/30">
      ...
      <div className="md:hidden space-y-3">
        {filteredReferrals.map((referral) => (
          <Card key={referral.id} className="p-4 bg-teal-900/20 border-teal-600/30">

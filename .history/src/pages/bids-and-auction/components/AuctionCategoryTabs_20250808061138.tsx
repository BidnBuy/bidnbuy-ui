...
/**
 * Category tabs component for auction filtering
 * Only visible on desktop as per requirements
 */
interface AuctionCategoryTabsProps {
...
export function AuctionCategoryTabs({ categories, onCategoryChange, className = "" }: AuctionCategoryTabsProps) {
  return (
    // Hidden on mobile (lg:block), only visible on desktop

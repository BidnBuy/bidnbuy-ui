...
import { completeUserProfile } from "@/services/kycService" // Import the service
...
interface CompleteProfileFormProps {
  ...
  // No jwtToken prop here, it comes from Zustand
  onSuccessRedirect?: (path: string) => void; // Callback for redirection
}
    ...
    onSuccess: (result) => {
      if (result.success) {
        toast({
          ...
          description: result.message || "Your profile has been successfully updated and wallet created.",
        });

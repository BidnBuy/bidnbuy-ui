...
export function AuctionFilter({ onFilterChange }: AuctionFilterProps) {
  ...
  const filters = ["All", "Ending Soon", "New Listings", "Popular", "Low Bids", "High Value"]
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="bg-slate-800 border-slate-700 text-white min-w-[150px]">
        {filters.map((filter) => (
          <DropdownMenuItem
            key={filter}

...
const OnboardingHero = () => {
  ...
  const navigate = useNavigate()
    ...
    const handleLiveBidsNavigate = () => navigate("/auction-product-detail")
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-row gap-4">
            <Button
            onClick={handleLiveBidsNavigate}
              size="lg"
              className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-3 text-base font-semibold rounded-lg transition-all duration-200 cursor-pointer"
            ...
            onClick={handleAccountNavigate}
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-[#01151C] px-8 py-3 text-base font-semibold rounded-lg transition-all duration-200 bg-transparent cursor-pointer"

      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-800 rounded-lg p-6">
            ...
            <h3 className="text-white text-lg font-semibold mb-2" style={{ fontFamily: "Open Sans, sans-serif" }}>
              Iphone 16 pink
            </h3>

            <div className="space-y-1 mb-4">
              <p className="text-white text-sm" style={{ fontFamily: "Open Sans, sans-serif" }}>

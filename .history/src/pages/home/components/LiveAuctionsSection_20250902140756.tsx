        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-800 rounded-lg p-6">
            ...
            <div className="space-y-1 mb-4">
              <p className="text-white text-sm">Current Bid: ₦1,250,000</p>
              <p className="text-white text-sm">2 bids</p>
              <p className="text-white text-sm">Time Left: 12h</p>
            </div>
          ...
          <div className="bg-slate-800 rounded-lg p-6">
            ...
            <div className="space-y-1 mb-4">
              <p className="text-white text-sm">Current Bid: ₦23,180</p>
              <p className="text-white text-sm">15 bids</p>
              <p className="text-white text-sm">Time Left: 2 days 2 hours</p>
            </div>

  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8">
      <Button
        ...
        className="flex flex-col items-center gap-2 h-auto py-4 md:py-6 bg-[#004755] hover:bg-[#00707B] border-[] text-white"
      >
      ...
      <Link to="/marketing/referrals">
        <Button className="w-full flex flex-col items-center gap-2 h-auto py-4 md:py-6 bg-[#004755] hover:bg-[#00707B] border-[] text-white">
          <Users className="w-6 h-6 md:w-8 md:h-8" />
          <span className="text-xs md:text-sm font-medium">My Referrals</span>
        </Button>
      </Link>

      <Button className="flex flex-col items-center gap-2 h-auto py-4 md:py-6 bg-[#004755] hover:bg-[#00707B] border-[] text-white">

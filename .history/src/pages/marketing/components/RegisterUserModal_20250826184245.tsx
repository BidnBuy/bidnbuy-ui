...
const RegisterUserModal = ({ open, onOpenChange }: RegisterUserModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md bg-[#01151C] border-teal-600 text-white">
        <DialogHeader>
        ...
        {showSuccess ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  className={
                    category === "buyer"
                      ? "bg-[#00707B] hover:bg-[hover:bg-[#00707B]] text-white"
            ...
            <Button
              type="submit"
              disabled={registerMutation.isPending}
              className="w-full bg-[#00707B] hover:bg-[#00707B] text-white"
            >

...
/**
 * @file features/admin-management/components/management-page-layout.tsx
 * @description Optimized reusable layout component for all management pages with proper loading states and navigation support.
 */

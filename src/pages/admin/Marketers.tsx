        ...
        <main className="flex-1 p-4 md:p-8 bg-[#01151C]">
          <div className="max-w-7xl mx-auto">
            <div className="md:hidden mb-6">
              <h1 className="text-white text-2xl font-bold mb-2">Marketers</h1>
              <p className="text-gray-300 text-base">Manage marketers and affiliates</p>
            </div>
            <div className="hidden md:block mb-8">
              <h1 className="text-white text-4xl font-bold mb-2">Marketers</h1>
            </div>

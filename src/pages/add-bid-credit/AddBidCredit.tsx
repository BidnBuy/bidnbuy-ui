...
/**
 * @file app/add-bid-credit/page.tsx
 * @description Page for selecting payment method and entering top-up amount.
 * This acts as a container component, handling state, mutations, and navigation.
 */
